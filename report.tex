...
\begin{minipage}{\textwidth}
    ...
    \raisebox{-0.5\height}{\includegraphics[width=0.10\textwidth]{figures/logos/contig.png}}
    \hspace*{0.01\textwidth}
    \raisebox{-0.5\height}{\includegraphics[height=0.25\textwidth]{figures/notebooks/chris-mock-length-distribution/even-contig.pdf}}
    \hspace*{0.01\textwidth}
    \raisebox{-0.5\height}{\includegraphics[height=0.25\textwidth]{figures/notebooks/chris-mock-length-distribution/uneven-contig.pdf}}
\end{minipage}
\begin{minipage}{\textwidth}
    \centering
    \raisebox{-0.5\height}{\includegraphics[width=0.10\textwidth]{figures/logos/contig-merge.png}}
    \hspace*{0.01\textwidth}
    \raisebox{-0.5\height}{\includegraphics[height=0.25\textwidth]{figures/notebooks/chris-mock-length-distribution/even-contig-merge.pdf}}
    \hspace*{0.01\textwidth}
    \raisebox{-0.5\height}{\includegraphics[height=0.25\textwidth]{figures/notebooks/chris-mock-length-distribution/uneven-contig-merge.pdf}}
\end{minipage}
\begin{minipage}{\textwidth}
    \centering
    \raisebox{-0.5\height}{\includegraphics[width=0.10\textwidth]{figures/logos/scaf.png}}
...
\begin{minipage}{\textwidth}
    ...
    \raisebox{-0.5\height}{\includegraphics[width=0.10\textwidth]{figures/logos/contig-scaf.png}}
    \hspace*{0.01\textwidth}
    \raisebox{-0.5\height}{\includegraphics[height=0.25\textwidth]{figures/notebooks/chris-mock-length-distribution/even-contig-scaf.pdf}}
    \hspace*{0.01\textwidth}
    \raisebox{-0.5\height}{\includegraphics[height=0.25\textwidth]{figures/notebooks/chris-mock-length-distribution/uneven-contig-scaf.pdf}}
\end{minipage}
\begin{minipage}{\textwidth}
    \centering
    \raisebox{-0.5\height}{\includegraphics[width=0.10\textwidth]{figures/logos/contig-merge-scaf.png}}
    \hspace*{0.01\textwidth}
    \raisebox{-0.5\height}{\includegraphics[height=0.25\textwidth]{figures/notebooks/chris-mock-length-distribution/even-contig-merge-scaf.pdf}}
    \hspace*{0.01\textwidth}
    \raisebox{-0.5\height}{\includegraphics[height=0.25\textwidth]{figures/notebooks/chris-mock-length-distribution/uneven-contig-merge-scaf.pdf}}
\end{minipage}
\caption{All that jazz}
\end{figure}
\clearpage
