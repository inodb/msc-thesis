...
\begin{figure}[ht!]
  ...
  \centering
    \includegraphics[width=\textwidth,trim=0 0 0 40, clip]{figures/notebooks/chris-mock-length-distribution/even-contig.pdf}
...
Meta-Velvet would seem a better candidate.\\
...
general the even library proofs an easier target for the assemblers than the unbalanced
library. In the first row that shows the contiging strategies, the unbalanced
sample increases the gap in sum of bases between Meta-Velvet and the other
assemblers even more. The merging strategies increase lengths quite
...
the assemblers improve lengths slightly, but the sum of bases decreases
substantially. For the external scaffolder, Bambus2, the sum decreases even
more.
